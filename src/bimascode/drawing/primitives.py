...
Geometry2D = Union[Line2D, Arc2D, Polyline2D, Hatch2D]
...
class ViewResult:
    ...
    Contains all linework, arcs, polylines, and hatches generated
    by a view, along with metadata about the view generation.
