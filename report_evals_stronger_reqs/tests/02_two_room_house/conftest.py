"""Pytest fixtures for Eval 02: Two Room House tests."""
import pytest
from pathlib import Path


# Testing TEST-AWARE builder version
@pytest.fixture
def output_dir():
    """Path to the output directory for this eval."""
    return Path(__file__).parent.parent.parent / "outputs" / "02_two_room_house_with_tests"
...
def pdf_path(output_dir):
    ...
    return output_dir / "02_two_room_house_drawing_set.pdf"
